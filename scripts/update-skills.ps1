...
# Usage:
#   scripts/update-skills.ps1           # pull + print diff
#   scripts/update-skills.ps1 -Check    # dry-run: exits 0 up-to-date, 2 updates available
#   scripts/update-skills.ps1 -Commit   # pull + print diff + commit submodule bump
