...
This file is generated by `scripts/generate_mcp_tools_doc.py`. Regenerate after changing tool definitions in `mcp_server/tools/`.

Server entrypoint: `python -m mcp_server.server` (stdio).

Each tool has an **audience guide** (synthesized from the registered `Tool` metadata), the **author registration text** (verbatim `Tool.description` from code), the JSON **input schema**, and a **behavior flow** Mermaid chart that reflects the real dispatch path (see `mcp_server/tools/*_tools.py` and `call_*_tool`). Diagrams follow the Pro Standard: neutral `%%{init}%%`, `classDef` node colors, muted `linkStyle`.
...
1. Implement `Tool(...)` in the appropriate `mcp_server/tools/*.py` and wire `call_*_tool` dispatch.
2. Register the name branch in [`mcp_server/server.py`](../mcp_server/server.py) `call_tool`.
3. Add `ToolAnnotations` (read-only vs destructive vs staging) and extend [`tests/mcp/test_tool_annotations.py`](../tests/mcp/test_tool_annotations.py) so `READ_ONLY` / `DESTRUCTIVE` / `STAGING` covers every tool.
4. Add or adjust the tool-specific Mermaid body in [`scripts/mcp_tools_doc_diagrams.py`](../scripts/mcp_tools_doc_diagrams.py) (`diagram_body_for_tool`) so generated docs match real behavior.
5. Re-run `python scripts/generate_mcp_tools_doc.py`.
...
**Dispatch:** [`mcp_server/tools/workflow_tools.py`](../mcp_server/tools/workflow_tools.py) `call_workflow_tool`
...
**Dispatch:** [`mcp_server/tools/skill_tools.py`](../mcp_server/tools/skill_tools.py) `call_skill_tool`
...
**Dispatch:** [`mcp_server/tools/agent_tools.py`](../mcp_server/tools/agent_tools.py) `call_agent_tool`
...
**Dispatch:** [`mcp_server/tools/doc_tools.py`](../mcp_server/tools/doc_tools.py) `call_doc_tool`
...
**Dispatch:** [`mcp_server/tools/memory_tools.py`](../mcp_server/tools/memory_tools.py) `call_memory_tool`
...
**Dispatch:** [`mcp_server/tools/library_tools.py`](../mcp_server/tools/library_tools.py) `call_library_tool`
...
**Dispatch:** [`mcp_server/tools/design_tools.py`](../mcp_server/tools/design_tools.py) `call_design_tool`
...
**Dispatch:** [`mcp_server/tools/intent_tools.py`](../mcp_server/tools/intent_tools.py) `call_intent_tool`
...
**Dispatch:** [`mcp_server/tools/answer_tools.py`](../mcp_server/tools/answer_tools.py) `call_answer_tool`
