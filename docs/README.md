...
- [CLAUDE_USER_GUIDE.md](CLAUDE_USER_GUIDE.md) — terminal / Claude Code setup, hooks-first policy, and how CLI differs from Cursor + MCP.
...
- Cursor skills: `.cursor/skills/uiplan/SKILL.md` (canonical planning + former brainstorm flow), `.cursor/skills/brainstorming-plan/SKILL.md` (redirect to uiplan only), `.cursor/skills/writing-uipath-plans/SKILL.md`, `.cursor/skills/mermaid-diagram-builder/SKILL.md`.
