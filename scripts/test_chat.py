...
Usage:
    python scripts/test_chat.py                    # Interactive mode
    python scripts/test_chat.py --prompt "..."     # Single prompt mode
    python scripts/test_chat.py --test-skills      # Test skill selection only
"""
import argparse
import sys
