...
![AgentOps Builder UI showcase](docs/assets/agentops-builder-ui.gif)
...
| **CLI / terminal-first path** | Headless or terminal-first `uipath-claude` with slash commands | [docs/USER_GUIDE.md](docs/USER_GUIDE.md) |
| **Pure Anthropic Claude Code** | Official `claude` CLI in the repo, skills as files, optional MCP; no `uipath-claude chat` | [docs/CURSOR_USER_GUIDE.md](docs/CURSOR_USER_GUIDE.md) |
...
| Work primarily in CLI (terminal / Claude Code) | [docs/USER_GUIDE.md](docs/USER_GUIDE.md) | Setup, hooks, slash-first workflow |
...
| Learn the recommended day-to-day usage patterns | [docs/CURSOR_USER_GUIDE.md](docs/CURSOR_USER_GUIDE.md#mcp-tools-advanced) + [docs/USER_GUIDE.md](docs/USER_GUIDE.md) | Cursor MCP playbooks, prompt shape, safety rules, CLI preflight, plans, validation |
...
- Terminal guide: [docs/USER_GUIDE.md](docs/USER_GUIDE.md); command reference: [docs/USER_GUIDE.md](docs/USER_GUIDE.md)
...
Guide: [docs/CURSOR_USER_GUIDE.md](docs/CURSOR_USER_GUIDE.md).
...
- [docs/USER_GUIDE.md](docs/USER_GUIDE.md) — Claude / terminal setup and workflow
