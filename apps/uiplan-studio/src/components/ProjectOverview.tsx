...
export default function ProjectOverview({ graph }: ProjectOverviewProps) {
    ...
    return (
      <div style={{ padding: 22, fontFamily: "'Inter', sans-serif", color: PALETTE.textDim }}>
        ...
        <div style={{ marginTop: 12, fontSize: 13, lineHeight: 1.55, fontFamily: "'Newsreader', Georgia, serif", fontStyle: "italic" }}>
          ...
          <code style={{ background: PALETTE.bg, border: `1px solid ${PALETTE.rule}`, padding: "1px 5px", borderRadius: 3, fontSize: 11 }}>
            overview
          </code>{" "}
  ...
  return (
    <div style={{ padding: 22, fontFamily: "'Inter', sans-serif", overflowY: "auto" }}>
      ...
      {overview.owner && (
        <div style={{ marginTop: 4, fontSize: 11.5, color: PALETTE.textDim, fontFamily: "'JetBrains Mono', monospace", letterSpacing: "0.05em" }}>
          ...
          <div style={{ marginTop: 10, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
            {overview.kpis.map((k, i) => (
              <div key={i} style={{
                ...
                <div style={{ fontSize: 9, letterSpacing: "0.15em", color: PALETTE.textDim, fontFamily: "'JetBrains Mono', monospace", fontWeight: 600 }}>
                  {k.label.toUpperCase()}
                </div>
          ...
          <div style={{ marginTop: 10, display: "flex", flexDirection: "column", gap: 6 }}>
            {overview.triggers.map((t, i) => (
              <div key={i} style={{
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: 10, color: "#2563eb", fontFamily: "'JetBrains Mono', monospace", letterSpacing: "0.15em", fontWeight: 700 }}>
                    {t.kind.toUpperCase()}
                  </div>
          ...
          <div style={{ marginTop: 10, display: "flex", flexDirection: "column", gap: 4 }}>
            {overview.actors.map((a, i) => (
              <div key={i} style={{
                ...
                <span style={{ marginLeft: "auto", fontSize: 10, color: PALETTE.textDim, fontFamily: "'JetBrains Mono', monospace", letterSpacing: "0.1em" }}>
                  {a.role}
                </span>
              </div>
            ))}
        ...
        <div style={{ marginTop: 22 }}>
          ...
          <div style={{ marginTop: 10, display: "flex", flexWrap: "wrap", gap: 6 }}>
            {overview.stakeholders.map((s) => (
              <span key={s} style={{
                fontSize: 11, color: PALETTE.text, fontWeight: 500,
      ...
      {overview.pdd && (
        <div style={{ marginTop: 22 }}>
          ...
          <div style={{
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 11, color: "#7c3aed", fontFamily: "'JetBrains Mono', monospace", letterSpacing: "0.1em", fontWeight: 700 }}>
                {overview.pdd.doc_id}
              </div>
    ...
    <div style={{ marginTop: 10, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 6 }}>
      {cells.map((c) => (
        <div key={c.label} style={{
          ...
          <span style={{ fontSize: 10, color: PALETTE.textDim, fontFamily: "'JetBrains Mono', monospace", letterSpacing: "0.1em", flex: 1 }}>
            {c.label}
          </span>
