...
# Usage:
#   scripts/update-skills.sh            # pull + print diff
#   scripts/update-skills.sh --check    # dry-run: exits 0 up-to-date, 2 updates available
#   scripts/update-skills.sh --commit   # pull + print diff + commit submodule bump
