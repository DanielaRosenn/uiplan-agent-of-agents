...
Usage:
    ...
    python scripts/run_e2e_skill_tests.py --test coded
    python scripts/run_e2e_skill_tests.py --test pdd
    python scripts/run_e2e_skill_tests.py --test sdd
    python scripts/run_e2e_skill_tests.py --test dispatcher
    python scripts/run_e2e_skill_tests.py --test performer
    python scripts/run_e2e_skill_tests.py --test long-running
